...
![Repo Size](https://img.shields.io/github/repo-size/твой-логин/название-репозитория)
![Stars](https://img.shields.io/github/stars/твой-логин/название-репозитория?style=social)

---

1. [Массивы](#1-массивы)
2. [Связные списки](#2-связные-списки)
3. [Стек (Stack)](#3-стек-stack)
4. [Очереди (Queues)](#4-очереди-queues)
5. [Бинарная куча (Binary heap)](#5-бинарная-куча-binary-heap)
6. [Хеш-таблица (Hash table)](#6-хеш-таблица-hash-table)
7. [Деревья (Trees)](#7-деревья-trees)
8. [Графы (Graphs)](#8-графы)

---

## 🧊 1. Массивы <a name="1-arrays"></a>
Базовая структура данных, представляющая собой коллекцию элементов, доступных по индексу.
...
Линейные структуры, в которых элементы связаны указателями.
...
Коллекции для управления потоком данных.
...
Эффективная реализация очереди с приоритетом на базе дерева.
...
Множество вершин и ребер между ними.
